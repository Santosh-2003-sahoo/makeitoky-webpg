...
function startLoadingAnimation() {
  ...
  const interval = setInterval(() => {
    if (width >= 100) {
      ...
      // Hide the loader or perform other actions when loading is complete
...
startButton.addEventListener("click", startLoadingAnimation);

// Attach a click event listener to close the popup
